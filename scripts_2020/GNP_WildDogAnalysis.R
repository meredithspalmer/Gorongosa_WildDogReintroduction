...
table(wd$DogName, wd$GroupName)
# -> some packs have multiple dogs collared; ensure that timeseries rather than temporal overlap 
...
compass() #note: figure does not point north 
